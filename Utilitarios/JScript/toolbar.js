...
if (ToolBar_Supported)
{
	...
	TBLStr  = "<TABLE BORDER=0 CELLPADDING=0 CELLSPACING=0><TR STYLE='height:19;vertical-align:middle'><!--ICP_MENU_TITLES--></TR></TABLE>";
	HTMLStr = 
		"<DIV ID='idToolbar'     STYLE='background-color:white;width:100%'>" +
		"<DIV ID='idRow3' STYLE='position:absolute;height:59;width:100%'>" +
		"<DIV ID='idICPMenuPane' STYLE='position:absolute;top:0;left:0;height:16;color:white;background-color:black;' NOWRAP><!--ICP_MENU_TITLES--></DIV>" +
		"</DIV>" +
		"</DIV>" +
	...
	ICPFont = "11px Tahoma";
	ICPFont1 = "bold 11px Tahoma";
	
	aDefMSColor[0]	= aCurMSColor[0]  = "black";	// bgcolor;
	aDefMSColor[1]	= aCurMSColor[1]  = "white" //"white";	// text font color
	aDefMSColor[2]  = aCurMSColor[2]  = "";		// mouseover font color
	
	aDefICPColor[0]	= aCurICPColor[0] = "#333399" //"#596784" //"#003399"//"#bd4900" //"#d99b75"//"#B0C4DE"//"#cc99cc";//"#6699CC";	// bgcolor;
	aDefICPColor[1] = aCurICPColor[1] = "white";	// text font color
	aDefICPColor[2] = aCurICPColor[2] = "#ffcc66"//"#00005F";		// mouseover font color
}
...
function drawToolbar()
{
	...
	ToolbarLoaded = true;
	MSMenuWidth     = Math.max(0, (200+112));
...
{
	cFont   = bICPMenu? ICPFont1 : MSFont;
	cFont1   = bICPMenu? ICPFont : MSFont;
	...
	cStyle1  = "font:" + cFont1 + ";background-color:" + cColor0 + ";color:" + cColor1 + ";";
	...
	MenuStr += " onmouseout="  + char34 + "mouseMenu('out' ,'" + MenuIDStr + "'); hideMenu();" + char34 + 
			   ...
			   "&nbsp;" + MenuDisplayStr + "&nbsp;</a>";
	if (bICPMenu) 
		MenuStr += "&nbsp;</TD><TD STYLE='" + cStyle1 + "'>|</TD>";
	else
		MenuStr += "</SPAN>";
