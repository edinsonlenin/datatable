...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="CalendarioFuncional.ascx.cs" Inherits="Seriva.Bolsa.Presentacion.Utilitarios.controles.CalendarioFuncional" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<SCRIPT language="javascript" src=pathScript   ig_dropCalendar.js?+?></SCRIPT>
<igsch:webcalendar id="SharedCalendar" runat="server">
<ClientSideEvents ValueChanged="seleccionarFecha"> </ClientSideEvents>
